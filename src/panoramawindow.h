...
public:
    ...
    //
    bool run(const std::string& pFileName, const SceneMetaData& pSceneMetaData, bool& pRequestPrev, bool& pRequestNext,
             bool pFullscreenMode = false);     ///< Display a picture as panorama scene in a window.
